...
# Active player csv
additional_data = pd.read_csv('playersBDL24.csv')
...
for abbrev in team_abbrevs:
    filename = f"S1_{abbrev}_2024_25.csv"
...
for team in team_lineup_stats.keys():
    ...
    df = df[columns]
    csv_path = os.path.join(save_dir, f"S1_{team}_2024_25.csv")
